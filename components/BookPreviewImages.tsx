...
export default function BookPreviewImages({
  ...
  return (
    <>
      ...
      {/* Page 1 */}
      <div className="card p-6 mb-6">
        <p className="text-sm font-bold uppercase tracking-wider text-brand-700 mb-2 text-center">
      ...
      <div className="card p-6 mb-6 relative overflow-hidden border-2 border-orange-400 bg-gradient-to-br from-orange-50 to-amber-50 shadow-lg">
        <p className="text-sm font-bold uppercase tracking-wider text-orange-700 mb-2 text-center">
        ...
        <p className="text-center text-base font-extrabold text-orange-900 mb-3 uppercase tracking-wider">
          {childName}&apos;s story is about to take a turn…
        </p>
        <p className="text-center text-lg text-gray-800 mb-4 italic blur-lg select-none">
        ...
        <p className="text-center text-base text-orange-900 mt-5 font-extrabold">
