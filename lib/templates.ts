...
const TEMPLATES: Record<Theme, Template> = {
  princess: {
    ...
    pages: (name) => [
      ...
      { text: `One night, ${name} heard a STRANGE tap-tap-tap at the window… something was scratching to get IN.`, scene: 'a young princess standing by a big castle window with curtains and a crescent moon outside, wide surprised eyes, sparkles floating in the air' },
      ...
      { text: `${name} promised to help. They tiptoed toward a secret castle door.`, scene: 'a young princess and a small dragon standing in front of a big ornate castle door with round handle, flowers growing beside the door, cheerful daytime scene' },
      ...
      { text: `The squirrel led them to a cave full of glowing crystals.`, scene: 'a smiling young princess with a crown standing in the center of the page, surrounded by several tall cartoon diamond crystal shapes on both sides with sparkle stars around them, plain white background, children coloring book style' },
      { text: `${name} picked the brightest crystal to light their path.`, scene: 'a princess holding up a single sparkling crystal' },
      { text: `Deeper inside, they found the shadow thief's lair.`, scene: 'an arched cave entrance decorated with hanging vines and cobwebs, a princess peeking in from outside' },
      { text: `A big shadow rose up — but ${name} was brave!`, scene: 'a small friendly cartoon ghost floating with a smiling face, a princess standing tall pointing a wand' },
      { text: `${name} held the crystal high, and the shadows turned into puffs of smoke.`, scene: 'a smiling young princess with a crown standing in the center holding up a large sparkling crystal above her head with both hands, a few simple star sparkles around the crystal, plain white background, children coloring book style' },
      ...
      { text: `From that day on, the dragon stayed as ${name}'s best friend.`, scene: 'a smiling young princess with a crown sitting on a large cushion on the left, a small cartoon dragon sitting upright on the floor next to her on the right, both clearly separated, simple castle room background, children coloring book style' },
      { text: `The End. ${name} and the little dragon watched the stars come out.`, scene: 'a smiling young princess with a crown standing on the left side, a small cartoon dragon standing on the right side on a stone balcony railing, both clearly separated with space between them, a few simple star shapes in the upper corners, plain white sky, children coloring book style' },
    ],
  },
  ...
  dinosaur: {
    ...
    pages: (name) => [
      ...
      { text: `Suddenly — a HUGE shadow! Was it a T-Rex??`, scene: 'a child in a safari hat looking up with a surprised face, tall ferns and a few clouds around, one giant dinosaur footprint on the ground' },
      ...
      { text: `Spike pointed to a big cave on the other side.`, scene: 'a small baby dinosaur standing on the right side with one front paw raised and pointing left, tall palm trees on the left side, bright white open space in the center, children coloring book style' },
      { text: `Inside, two big friendly eyes peeked out!`, scene: 'a cute small pterodactyl peeking out from a round cave entrance, just the head visible, big round friendly eyes' },
      ...
      { text: `${name} promised to come back tomorrow.`, scene: 'a child standing on the left with one pinky finger extended, a small cartoon dinosaur standing on the right with one claw extended, a clear gap between them, plain white background, children coloring book style' },
  ...
  space: {
    ...
    pages: (name) => [
      { text: `${name} loved looking up at the stars every night.`, scene: 'a smiling child leaning on a round window sill from the inside, the window frame clearly visible, a large crescent moon outline and a few small star outlines placed in the upper corners against plain white, children coloring book style' },
      ...
      { text: `Zip's home planet had lost all its stars and felt very lonely.`, scene: 'a round planet with a sad droopy face and big sad eyes, a few tear drops floating beside it' },
      ...
      { text: `They landed on Zip's quiet planet.`, scene: 'a small rocket landing on top of a round cartoon planet with a sad face, little puffs of smoke around the landing legs' },
      ...
      { text: `The End. Every night ${name} can see Zip's bright star.`, scene: 'a child standing inside a bedroom pointing at a single large star outline in the upper corner, a simple rectangular window frame outline on the wall, plain white background, children coloring book style' },
    ],
  },
  ...
  unicorn: {
    ...
    pages: (name) => [
      ...
      { text: `The End. ${name} held the crystal close, safe and warm.`, scene: 'a child holding a small glowing crystal to the chest, a few simple star outlines in the upper corners, plain white background, children coloring book style' },
    ],
  },
  ...
  underwater: {
    ...
    pages: (name) => [
      ...
      { text: `${name} put on a snorkel mask and could magically breathe under water.`, scene: 'a child wearing a snorkel mask and flippers standing at the water edge, fish outlines and bubble outlines around them, plain white background, children coloring book style' },
      { text: `A friendly dolphin came to swim alongside them.`, scene: 'a smiling cartoon dolphin swimming next to a child' },
      { text: `They passed a wide coral reef bursting with colorful fish.`, scene: 'a tall coral reef with branch and fan shapes, several small fish outlines swimming around it, bubble outlines floating upward, plain white background, children coloring book style' },
      { text: `Suddenly — a big shape swam by! A shark!`, scene: 'a child with a snorkel mask and a small mermaid standing on the left side with surprised faces, a large cartoon shark with a friendly smile swimming past on the right, bubble outlines around, plain white background, children coloring book style' },
      { text: `It was just a gentle giant basking shark, who waved a fin.`, scene: 'a friendly basking shark with kind eyes waving a fin' },
      { text: `Pearl led ${name} to a deep secret cave.`, scene: 'a child with a snorkel mask and a small mermaid swimming toward a large round cave entrance arch decorated with coral and seaweed on the outside, the cave opening left as plain white space inside, bubble outlines floating around, plain white background, children coloring book style' },
      ...
      { text: `They swam to the underwater mermaid kingdom.`, scene: 'a tall castle with towers made of coral shapes and seashell outlines, two small mermaid figures beside the gate, bubble outlines and small fish around, plain white background, children coloring book style' },
      ...
      { text: `The dolphin carried ${name} back up to the sunny surface.`, scene: 'a child riding on the back of a smiling dolphin, the dolphin pointing upward, bubble outlines and a few small fish outlines around, a simple sun outline in the upper corner, plain white background, children coloring book style' },
